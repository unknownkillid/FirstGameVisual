...
function accelerateRocket() {
  ...
  document.addEventListener("keydown", (event) => {
    ...
    if (event.code === "Space") {
      ...
      bullet.style.top = y - -130 + "px";
      bullet.style.left = x + rocket + "px";
...
// let rame = document.querySelector('#somebutton');
// rame.addEventListener('click', function(){
//   if (rame.style.color = 'red'){
//     startGame.style.display = 'none';
//     settingsMenu.style.display = 'block';
//   }
// })
